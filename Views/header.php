    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0" style="margin-left: 20px;">
                <li><a href="os.php" class="nav-link px-2 removerLink <?php echo @$corTituloOS; ?>" title="Página com a lista de Ordens de Serviços"><i class="fas fa-clipboard"></i> Ordens de Serviço</a></li>
            ...
            <div class="text-end">
                <a href="../App/Controls/control_logout.php"><button type="button" class="btn btn-light" title="Logout"><i class="fas fa-sign-out-alt"></i> Sair</button></a>
            </div>
        </div>
    </div>
</header>